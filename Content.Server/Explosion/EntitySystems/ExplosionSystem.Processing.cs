            ...
            foreach (var (entity, damage) in _toDamage)
            {
                ...
                if (!WouldTriggerDestructibleThreshold(entity, damage, cause))
                    _damageableSystem.TryChangeDamage(entity,
                        ...
                        splitDamage: SplitDamageBehavior.SplitExplosion,
                        originFlag: DamageableSystem.DamageOriginFlag.Explosion); // Shitmed Change; Pirate: armor plates.
            }
        }
    ...
    public int Process(int processingTarget)
    {
        ...
        for (processed = 0; processed < processingTarget; processed++)
        {
            ...
            if (_currentGrid != null &&
                _mapSystem.TryGetTileRef(_currentGrid.Owner, _currentGrid, _currentEnumerator.Current, out var tileRef) &&
