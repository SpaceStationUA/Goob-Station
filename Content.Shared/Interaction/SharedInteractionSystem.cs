...
namespace Content.Shared.Interaction
{
    ...
    public abstract partial class SharedInteractionSystem : EntitySystem
    {
            ...
            bool checkCanUse = true)
        {
            ...
            if (!TryGetUsedEntity(user, out var used, checkCanUse))
            {
                if (inRangeUnobstructed && target != null)
                    InteractHand(user, target.Value, coordinates);
        ...
        public bool InteractHand(EntityUid user, EntityUid target, EntityCoordinates? clickLocation = null) // Goobstation - useful return value
        {
            ...
            var message = new InteractHandEvent(user, target, clickLocation);
