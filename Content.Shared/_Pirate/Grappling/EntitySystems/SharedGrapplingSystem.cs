using Content.Shared._Pirate.Grappling.Components;
using Content.Shared._Pirate.Grappling.Events;
...
namespace Content.Shared._Pirate.Grappling.EntitySystems;
...
public sealed partial class SharedGrapplingSystem : EntitySystem
{
    ...
    private void ActivateGrapplingForVictim(Entity<GrappledComponent> victim)
    {
        ...
        _stamina.ToggleStaminaDrain(victim,
            ...
            false,
            false,
            GetStaminaDrainKey(victim.Comp.Grappler),
            victim.Comp.Grappler);
    }
    ...
    private void DisableHands(Entity<GrapplerComponent> grappler, Entity<GrappledComponent> victim)
    {
        ...
        {
            if (_virtual.TrySpawnVirtualItemInHand(grappler,
                    victim,
                    out var virtItem,
                    dropOthers: true,
                    empty: hand))
