...
knowledge-editor-profile-unavailable = No skill profile is available for this species.
knowledge-editor-decrease = Decrease mastery
knowledge-editor-increase = Increase mastery
knowledge-editor-level-mastery = Level {$level} · {$mastery}
knowledge-editor-cost = Cost: {$cost}
knowledge-editor-breakdown = Profile: {$profile} | Job chips: {$job} | Employer: {$employer} | Total: {$total}
knowledge-editor-source-profile = Profile
knowledge-editor-source-job = Job chips
knowledge-editor-source-employer = Employer
knowledge-editor-source-penalty = Penalty
knowledge-editor-source-potential = Untrained
knowledge-editor-reset = Reset
