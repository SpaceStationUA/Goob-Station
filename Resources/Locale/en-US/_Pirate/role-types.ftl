role-type-cybersun-name = Cybersun
role-type-cybersun-color = #a66a4c

ghost-role-information-rules-cybersun = You are part of [color={role-type-cybersun-color}][bold]{role-type-cybersun-name}[/bold][/color]. Your intentions are harmful to the station and its crew.
