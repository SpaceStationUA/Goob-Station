...
psionic-power-name-eruption = Псіонічне виверження
psionic-power-name-mass-sleep = Масовий сон
psionic-power-name-mindswap = Обмін розумами
psionic-power-name-mindswap-return = Повернення після обміну розумами
psionic-power-name-metapsionic = Мета-псіонічний імпульс
psionic-power-name-noospheric-zap = Ноосферний розряд
psionic-power-name-psychokinetic = Псіокінетичний крик
psionic-power-name-psionic-regeneration = Псіонічна регенерація
...
psionic-cannot-use-psionics = Ваша псіонічна енергія не може вирватися з вашого розуму!
psionic-shielded-from-attempt = Псіонічний вплив розбився об ваш щит!
psionic-cannot-target-shielded = Вони залишаються непохитними перед вашою псіонічною хваткою!
psionic-equipped-shielded-in-doafter = Ізоляційне спорядження зруйнувало вашу концентрацію..
psionic-dispelled = Хтось розвіяв вашу псіонічну концентрацію!
psionic-power-metapsionic-success = Ви виявляєте там психічну присутність.
psionic-power-metapsionic-failure = Ви не виявляєте жодної психічної присутності.
psionic-power-metapsionic-power-detected = Ви виявляєте, що {$power} було використано поблизу.
psionic-power-mindswap-target-mindshielded = Ваш ментальний щит.. несподівано захистив ваш розум від псіонічного впливу.
psionic-power-mindswap-own-mindshield = Ваш ментальний щит.. не дає вашому розуму залишити тіло.
psionic-power-mindswap-original-lost = Псіонічний зв’язок із вашим початковим тілом було перервано!
psionic-power-noospheric-zap-user = Із кінчиків пальців {THE($user)} виривається блискавка!
psionic-power-noospheric-zap-battery = Заряд {CAPITALIZE(THE($battery))} зростає!
psionic-eruption-begin = Псіонічна енергія поглинає {CAPITALIZE(THE($user))}!
psionic-eruption-annoy-minimal = Ви відчуваєте, як у вашому розумі наростає тиск.
psionic-eruption-annoy-low = Від псіонічної енергії у вас болить голова.
psionic-eruption-annoy-moderate = Ви відчуваєте сильний тиск у своєму розумі. Зупиніть це!
psionic-eruption-annoy-high = Від псіонічної енергії у вас розколюється голова. Вам потрібно її вивільнити!
psionic-eruption-annoy-dangerous = Ваша голова ось-ось вибухне від псіонічної енергії!
psionic-eruption-annoy-critical = Зупиніть це! Зупиніть це! Зупиніть це!
...
eruption-warning-window-prompt-text-part = Ви відчуваєте сильний тиск, що наростає у вашому розумі
                                            і вам потрібно вивільнити його, перш ніж він вас переповнить.
                                            Коли будете готові, ви зможете вивільнити псіонічне виверження.
                                            Це спричинить масовий псіонічний розряд, який повністю вас знищить.
                                            Вам, мабуть, варто спробувати знайти вирішення цієї проблеми...
                                            Не детонуйте випадково, дочекайтеся належного накопичення.
                                            Ви розумієте?
eruption-warning-window-acknowledge-button = Я розумію
gamerule-noospheric-zap-seize = Зовнішнє виверження переповнює ваш розум!
gamerule-noospheric-zap-seize-potential-regained = Ваш розум перебудовується.. він вимагає знань...
psionic-nosebleed-message = У вас із носа хлине кров!
mass-mind-swap-event-announcement = Попередження: виявлено аномальний викид мерехтіння. Неминуча подія масового перенесення свідомості, T-{$time} секунд. Негайно надягніть псіонічно ізольований головний убір.
mass-mind-swap-event-sender = Софічний граматей
minor-mass-mind-swap-event-announcement = Попередження: виявлено аномальний викид мерехтіння. Неминуча мала подія масового перенесення свідомості, T-{$time} секунд. Негайно надягніть псіонічно ізольований головний убір.
minor-mass-mind-swap-event-sender = Софічний граматей
psionic-power-mass-sleep-warning = Ваші повіки починають опускатися...
healing-word-begin = {CAPITALIZE(THE($entity))} промовляє слово, що зігріває всіх довкола.
healing-word-target = Ви починаєте направляти цілющу енергію в {THE($target)}.
revivify-begin = {CAPITALIZE(THE($entity))} промовляє лагідні слова, що зігрівають душу.
revivify-target = Ви починаєте направляти енергію воскресіння в {THE($target)}.
...
assay-potential = {CAPITALIZE(THE($entity))} має насіння світла в собі.
assay-psionic = Золота гілка лунає від души {CAPITALIZE($entity)}; у її відблисках видно:
...
telegnosis-power-ssd = { CAPITALIZE(POSS-ADJ($ent)) } очі розфокусовані й бігають, наче намагаються побачити те, чого не існує.
glimmer-restyle-event = Ви відчуваєте, ніби щось змінилося у вашій зовнішності...
