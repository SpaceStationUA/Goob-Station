...
ent-CrateEngineeringHFR = Ящик з платами гіпертороїдного термоядерного реактора
    .desc = Містить плати для ядра гіпертороїдного термоядерного реактора та всіх його портів.