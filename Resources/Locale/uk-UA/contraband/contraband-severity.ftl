...
contraband-examine-text-Minor = [color=yellow]Цей предмет вважається незначною контрабандою.[/color]
contraband-examine-text-Restricted = [color=yellow]Цей предмет має обмеження за відділом.[/color]
