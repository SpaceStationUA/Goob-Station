...
gas-miasma-abbreviation = МІА
gas-halon-abbreviation = ГАЛ

# Назви газів
gases-hyper-noblium = Гіпер-Ноблій
gases-anti-noblium = Анти-Ноблій
gases-hydrogen = Водень
gases-helium = Гелій
gases-proto-nitrate = Прото-Нітрат
gases-zauker = Заукер
gases-miasma = Міазма
gases-halon = Галон
...
reagent-desc-zauker = Дуже токсичний газ, його виробництво важке і жорстко регулюється. Розкладається при контакті з азотом.
reagent-name-miasma = міазма
reagent-desc-miasma = Не стільки газ, скільки біологічні забруднювачі в атмосфері.
reagent-name-halon = галон
reagent-desc-halon = Потужний засіб пожежогасіння. Забирає кисень із високотемпературних пожеж і охолоджує територію.
