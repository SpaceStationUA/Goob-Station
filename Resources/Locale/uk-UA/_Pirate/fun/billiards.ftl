...
ent-TableBilliard = більярдний стіл
    .desc = Стандартний більярдний стіл із зеленим сукном. Ідеальне місце для відпочинку після зміни.
ent-BilliardBall = більярдна куля
...
ent-SpawnBilliardAmericanPool = спавнер піраміди американського пулу
...
ent-BoxBilliardBalls = коробка для більярдних куль
    .desc = Коробка для зберігання більярдних куль.
ent-CrateBilliardComplect = ящик із комплектом для більярду
    .desc = Флетпак більярдного столу, коробка куль і два киї: усе, що треба для гарного вечора.
