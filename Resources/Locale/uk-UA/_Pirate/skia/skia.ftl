...
ghost-role-information-skia-rules =
    ...
    Ви можете вбити свою ціль, але не мусите утримувати її мертвою.
    Уникайте нападів на інших, окрім самозахисту або випадків, коли це потрібно для смерті цілі.

skia-role-briefing =
    Ви Скія, тінь Ноосфери.
    Ви пов'язані з темрявою й тінями, використовуйте темряву собі на користь.
    Знайдіть здобич і заберіть її душу, вбивши її. Уникайте смертей невинних.
...
skia-alert-light-neutral-name = Тьмяне світло
skia-alert-light-neutral-desc = Ви перебуваєте в тьмяно освітленому місці.
skia-alert-light-bright-name = Яскраве світло
skia-alert-light-bright-desc = Ви перебуваєте в яскраво освітленому місці.
skia-alert-resurrecting-name = Відновлення
