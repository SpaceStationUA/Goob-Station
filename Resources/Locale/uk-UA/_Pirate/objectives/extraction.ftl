...
extraction-fulton-remove-first = Спочатку зніміть фултон!
extraction-fulton-inside-container = Спочатку вийміть це з контейнера.

syndicate-ransom-announcement-sender = Автоматизовані системи
syndicate-ransom-announcement =
    Отримано повідомлення від Синдикату. {$hostage} захоплено як заручника для викупу.
    Синдикат вимагає {$ransom} спесо. Запит автоматично додано до консолі замовлень вантажного відділу.
    Загроза через зволікання: ВИСОКА.
