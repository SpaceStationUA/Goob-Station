...
public sealed partial class ModularSuitComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier LowPowerSound = new SoundPathSpecifier("/Audio/_Pirate/Effects/Modsuit/lowpower.ogg", AudioParams.Default.WithVolume(4));

    [DataField]
    public SoundSpecifier CriticalDamageSound = new SoundPathSpecifier("/Audio/_Pirate/Effects/Modsuit/critnano.ogg", AudioParams.Default.WithVolume(4));

    [DataField]
    public SoundSpecifier CriticalDestroySound = new SoundPathSpecifier("/Audio/_Pirate/Effects/Modsuit/critdestr.ogg", AudioParams.Default.WithVolume(4));
