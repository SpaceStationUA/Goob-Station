...
public sealed partial class ReplicatorNestComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier UpgradeSound = new SoundPathSpecifier("/Audio/_Pirate/Misc/replicator_sfx2.ogg");
    [DataField]
    public SoundSpecifier TilePlaceSound = new SoundPathSpecifier("/Audio/_Pirate/Misc/replicator_sfx1.ogg");
    [DataField]
