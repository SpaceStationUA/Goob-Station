...
using Content.Pirate.Client.Viewcone.ComponentTree;
...
namespace Content.Pirate.Client.Viewcone.Overlays;
...
public sealed partial class ViewconeSetAlphaOverlay : Overlay
{
    ...
    // Pirate: source uses HumanoidProfileComponent, GS2's equivalent is HumanoidAppearanceComponent.
    ...
    public ViewconeSetAlphaOverlay()
    {
        ...
        _humanoidQuery = _ent.GetEntityQuery<HumanoidAppearanceComponent>();
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        foreach (var entry in _occludables)
        {
            ...
            var (entPos, _) = _xform.GetWorldPositionRotation(xform);
            ...
            if (!_spriteQuery.HasComp(memory))
            {
