...
namespace Content.Pirate.Client.Botany.PlantAnalyzer;
...
public sealed partial class PlantAnalyzerWindow : FancyWindow
{
    ...
    public PlantAnalyzerWindow()
    {
        ...
        _atmosphereSystem = _entityManager.System<SharedAtmosphereSystem>();
    }
    ...
    public void Populate(PlantAnalyzerScannedUserMessage msg)
    {
        ...
        if (msg.TolerancesData is not null)
        {
            (string, string)[] parameters = [
                ...
                ("gases", PlantAnalyzerLocalizationHelper.GasesToLocalizedStrings(msg.TolerancesData.ConsumeGasses, _atmosphereSystem)),
        ...
        {
            var gases = PlantAnalyzerLocalizationHelper.GasesToLocalizedStrings(msg.ProduceData.ExudeGasses, _atmosphereSystem);
