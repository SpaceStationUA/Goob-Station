...
public sealed partial class AACWindow : FancyWindow
{
    ...
    public event Action<List<ProtoId<QuickPhrasePrototype>>, ProtoId<RadioChannelPrototype>?>? PhraseButtonPressed;
    ...
    {
        PhraseButtonPressed?.Invoke(_phraseBuffer, Channel);
        _phraseBuffer.Clear();
        BufferedString.Text = string.Empty;
        SubmitPressed?.Invoke();
    }
    ...
    private void OnPhraseButtonPressed(ProtoId<QuickPhrasePrototype> phraseId)
    {
        ...
        else
        {
            ...
            PhraseButtonPressed?.Invoke(_phraseSingle, Channel);
            SubmitPressed?.Invoke();
        }
    }
    ...
    internal void Update(AACTabletBuiState msg)
    {
        ...
        var id = 0;
        RadioChannels.AddItem(Loc.GetString("aac-tablet-local-channel"), id);
        ...
        foreach (var channel in msg.RadioChannels)
        {
            ...
            RadioChannels.SetItemMetadata(RadioChannels.GetIdx(id), channel);
        }
    }
}
