...
public sealed partial class NuclearReactorSystem : SharedNuclearReactorSystem
{
    ...
    private void OnMapInit(Entity<NuclearReactorComponent> ent, ref MapInitEvent args)
    {
        ...
        _ambient.SetSound(comp.AlarmAudioHighTemp.Value, new SoundPathSpecifier("/Audio/_Pirate/Nuclear/Machines/reactor_alarm_2.ogg"));
        comp.AlarmAudioHighRads = SpawnAttachedTo("ReactorAlarmEntity", new(uid, 0, 0));
        _ambient.SetSound(comp.AlarmAudioHighRads.Value, new SoundPathSpecifier("/Audio/_Pirate/Nuclear/Machines/reactor_alarm_3.ogg"));
    }
    ...
    private void OnUpdate(Entity<NuclearReactorComponent> ent, ref AtmosDeviceUpdateEvent args)
    {
        ...
        var rodsMoved = controlRods > 0 && !MathHelper.CloseTo(comp.AvgInsertion, avgControlRodInsertion);
        ...
        if (rodsMoved)
            Audio.PlayPvs(new SoundPathSpecifier("/Audio/_Pirate/Nuclear/Machines/relay_click.ogg"), uid);
