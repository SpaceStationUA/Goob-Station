...
public sealed partial class ReactorPartSystem : EntitySystem
{
    ...
    private void OnIngest(Entity<NuclearPropertiesComponent> ent, ref IngestedEvent args)
    {
        ...
        _damage.TryChangeDamage(args.Target, damage, targetPart: TargetBodyPart.Chest);
    }
    ...
    private void AccUpdate()
    {
        ...
        while (query.MoveNext(out var uid, out var comp, out var xform))
        {
            ...
            {
                // Pirate: Far Horizons RCU10 caps contact burns so an overheated part cannot instantly ash someone.
                var damage = Math.Clamp((comp.Temperature - _hotTemp) / _burnDiv, 0, 100);
