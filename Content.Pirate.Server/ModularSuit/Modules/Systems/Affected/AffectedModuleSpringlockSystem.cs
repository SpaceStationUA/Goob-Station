...
public sealed partial class AffectedModuleSpringlockSystem : EntitySystem
{
    ...
    private void OnReaction(Entity<AffectedModuleSpringlockComponent> ent, ref ReactionEntityEvent args)
    {
        ...
        var alert = new SoundPathSpecifier("/Audio/_Pirate/Effects/Modsuit/springlock.ogg");
        ...
        Timer.Spawn(TimeSpan.FromSeconds(5), () =>
        {
            ...
            if (HasComp<AffectedModuleSpringlockComponent>(user))
            {
                ...
                Timer.Spawn(TimeSpan.FromSeconds(4), () =>
                {
                    ...
                    _audio.PlayGlobal(new SoundPathSpecifier("/Audio/_Pirate/Ambience/toreadormarch.ogg"), actor.PlayerSession);
                });
            }
        });
    }
