...
public sealed partial class GoggleShaderSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<GoggleShaderComponent, AfterAutoHandleStateEvent>(OnHandleState);
    ...
    {
        if (args.Equipee == _playerManager.LocalEntity && (args.Slot == HeadString || args.Slot == EyeString))
            RefreshOverlay();
    }
