...
public sealed partial class AudioMuffleSystem : SharedAudioMuffleSystem
{
    ...
    private EntityQuery<RelayInputMoverComponent> _relayedQuery;
    private EntityQuery<AiEyeComponent> _aiEyeQuery;
    private EntityQuery<SoundBlockerComponent> _blockerQuery;
