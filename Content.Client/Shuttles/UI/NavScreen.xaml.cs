...
using Content.Shared.Timing; // Far Horizons
...
public sealed partial class NavScreen : BoxContainer
{
    ...
    public NavScreen()
    {
        ...
        NavRadar.RequestPlanetDescend += planet => RequestPlanetDescend?.Invoke(planet); // Far Horizons
    ...
    /// <summary>Far Horizons: mirrors the map screen's descent charge/refusal feedback onto the radar.</summary>
    public void SetDescentState(NetEntity planet, StartEndTime time, string? denyReason, TimeSpan denyUntil)
    {
        NavRadar.SetDescentState(planet, time, denyReason, denyUntil);
    }
