...
using Content.Client._Pirate.Options; // Pirate: multiz
...
public sealed partial class GraphicsTab : Control
{
    ...
    public GraphicsTab()
    {
        ...
        Control.AddOptionCheckBox(CCVars.MoodVisualEffects, MoodVisualEffectsCheckBox); // Pirate: mood color grading tweaks
