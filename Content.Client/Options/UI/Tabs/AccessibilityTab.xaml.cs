...
using PirateCVars = Content.Pirate.Common.CCVar.PirateCVars;
...
public sealed partial class AccessibilityTab : Control
{
    public AccessibilityTab()
    {
        ...
        Control.AddOptionPercentSlider(PirateCVars.VisionGrainScale, VisionGrainScaleSlider); // Pirate: viewcone
