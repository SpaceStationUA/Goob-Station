...
internal sealed class AdminNameOverlay : Overlay
{
    ...
    private static readonly FrozenSet<ProtoId<RoleTypePrototype>> Filter =
        new ProtoId<RoleTypePrototype>[] {"SoloAntagonist", "TeamAntagonist", "SiliconAntagonist", "FreeAgent", "SentientAnimal", "Cybersun"} // Goobstation - Sentient Animals adds SentientAnimal // Pirate: cybersun roles
        .ToFrozenSet();
