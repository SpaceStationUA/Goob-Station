...
using Content.Shared._Pirate.CartridgeLoader; // Pirate: detomatix
...
namespace Content.Client.PDA
{
    ...
    public sealed partial class PdaMenu : PdaWindow
    {
        ...
        [Dependency] private readonly IEntityManager _entMan = default!; // Pirate: detomatix
        ...
        public void UpdateAvailablePrograms(List<(EntityUid, CartridgeComponent)> programs)
        {
            ...
            foreach (var (uid, component) in programs)
            {
                ...
                {
                    // Pirate: detomatix - slot-only cartridges get no install button, since the server
                    // refuses the install anyway and a button that does nothing just reads as broken.
                    case InstallationStatus.Cartridge when _entMan.HasComponent<NonInstallableProgramComponent>(uid):
                        break;
